package lambda.work.javazoos.config;
...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("lambda.work.javazoos"))
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("Java Zoos")
                .description("Java zoo project")
                .contact(new Contact("Sam Kester",
                        "",
                        ""))
                .license("MIT")
                .licenseUrl("https://github.com/samkester/java-zoos/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}